...
class Tagihan extends Model
{
    ...
    protected $fillable = ['pelanggan_id','pemakaian_id','abonemen_id','harga_per_meter','jumlah_pakai','administrasi','telat','denda_keterlambatan','tagihan','jenis_bayar','status'];
